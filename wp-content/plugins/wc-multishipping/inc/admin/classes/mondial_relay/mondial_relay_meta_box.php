...
class mondial_relay_meta_box extends abstract_meta_box
{
    ...
    private function display_insurance_options()
    {
		...
		<tr>
			<td colspan="2">
				<a href="https://www.mondialrelay.fr/faq/paiements/comment-ajouter-une-assurance-a-la-creation-d-un-envoi-/" target="_blank">
    ...
    private function display_shipping_value_options()
    {
        ...
        if ('' === $shipping_value) $shipping_value = $this->order->get_subtotal() * 100;
