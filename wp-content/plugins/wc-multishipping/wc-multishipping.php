...
add_action('enqueue_block_assets', function () {
    ...
    foreach ($shipping_providers as $one_shipping_provider) {
        ...
        if ("mondial_relay_map" == get_option('wms_'.$one_shipping_provider.'_section_pickup_points_map_type', 'openstreetmap')) $mondial_relay_map_is_used = true;
        if ("openstreetmap" == get_option('wms_'.$one_shipping_provider.'_section_pickup_points_map_type', 'openstreetmap')) $open_street_maps_is_used = true;
    }
...
add_action('wp_footer', function () {
    ...
    if (!has_block("woocommerce/checkout", $post->post_content) && !is_checkout()) return;
