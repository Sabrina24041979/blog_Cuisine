    ...
    protected function display_parcel_information()
    {
		...
		<tr id="wms_parcels_number">
			...
			<td class=wms_parcels_number">
				<input id="wms_parcels_number_input" name="_wms_ups_parcels_number" type="number" value="<?php echo wms_display_value($parcel_number_meta); ?>"
					   min="1"
					   style="width: 100%;"
        ...
        foreach ($one_parcel_dimensions as $one_dimension_label => $one_dimension_value) : ?>
			<tr>
				...
				<td>
					<input name="_wms_ups_parcels_dimensions[<?php echo wms_display_value($one_parcel_number); ?>][<?php echo wms_display_value($one_dimension_label); ?>]" type="number" class="default"
