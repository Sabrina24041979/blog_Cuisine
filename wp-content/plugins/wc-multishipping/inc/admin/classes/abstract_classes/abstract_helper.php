...
abstract class abstract_helper
{
    ...
    public static function register_hooks()
    {
        ...
        add_action('woocommerce_update_order', [$page, 'save_meta_box_values'], 10, 3);
        add_action('woocommerce_update_order', [$page, 'save_admin_shipping_method_selection'], 10, 3);
    ...
    {
        if ($post_type !== "woocommerce_page_wc-orders" && 'shop_order' != get_post_type(get_the_ID())) return;
    ...
    {
        if ('shop_order' != get_post_type($post_id) && 'shop_order_placehold' != get_post_type($post_id)) return;
