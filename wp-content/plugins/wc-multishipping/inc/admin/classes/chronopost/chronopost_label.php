...
class chronopost_label extends abstract_label
{
    ...
    public function build_outcome_payload($order)
    {
        ...
        if (empty($this->with_scheduled_value($order))) return false;
    ...
    public function with_shipper($order, $is_return_order = false)
    {
        ...
        if (!$is_return_order) {
            ...
            if (4 == strlen($zipCode)) $zipCode = "0".$zipCode;
    ...
    public function with_scheduled_value($order)
    {
        ...
        if ($shipping_method_id != 'chronopost_13_fresh') return $this;
    ...
    protected function with_tracking_number($order)
    {
        ...
        if (empty($shipment_data['_wms_outward_parcels']['_wms_parcels'][0]['_wms_parcel_skybill_number'])) return false;
